...
male_participants = ['P1_H', 'P1', 'P2_V_3', 'P2_H','P3_H', 'P3_V', 'P5', 'P5_H', 'P6_H', 'P6_V', 'P8_H', 'P8_V_2', 'P9_H', 'P9_V', 'P11_H', 'P11_V', 'P15_H', 'P15_V', 'P18_H', 'P18_V', 'P20_V', 'P20_H']
female_participants = ['P4_H', 'P4_V', 'P7', 'P7_V', 'P10_H', 'P10_V', 'P12_H', 'P12_V', 'P14_H', 'P14_V', 'P16_H', 'P16_V', 'P17_H', 'P17_V', 'P19_H', 'P19_V', 'P21_H', 'P21_V', 'P22_H', 'P22_V', 'P23_H', 'P23_V']
...
for sets in range(16):
    ...
    plt.title(new_setting.layout + " " + new_setting.metaphor + " " + new_setting.intensity + " " + new_setting.guidance_approach)
    plt.plot()
    for p in participants:
        if p in male_participants:
            check = file_processor(p, new_setting, blue_colors[male_counter])
            if check:
                print(p)
                male_counter += 1
        ...
        # plt.plot([x_start, x_end], [y_start, y_end], color='blue', label='Random Line')
            ...
            check = file_processor(p, new_setting, red_colors[female_counter])
            if check:
                female_counter += 1
    center = (0, 0)
    radius = 35
    ...
    plt.xlim(-60, 60)
    plt.ylim(-60, 60)
    plt.savefig('Gender_Figures/setting_' + str(sets) + '.png')
    plt.close()
