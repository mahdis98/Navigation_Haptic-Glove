...
response_column = 14  # 0-indexed, represents the 5th column
...
fig, axes = plt.subplots(1, 5, figsize=(6.1, 8), sharey=True, gridspec_kw={'width_ratios': [1.5, 4, 2.5, 4, 1.5]})
...
plt.savefig("prelim_figures/percentage_main_effects.png")
