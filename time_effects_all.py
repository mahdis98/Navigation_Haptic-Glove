...
def main_effects(f):
    ...
    response_column = 10  # 0-indexed, represents the 5th column
...
add_significance_bar(0, 2, 143, 141, "", axess)
add_significance_bar(1, 2, 123, 121, "", axess)
add_significance_bar(0, 1, 133, 131, "", axess)
add_significance_bar(2, 3, 133, 131, "", axess)
...
axess.text(2.5, -20, 'Vertical', ha='center', va='center', fontsize=18)
axess.text(0.5, -20, 'Horizontal', ha='center', va='center', fontsize=18)

# Adjust y-axis limits to make space for the text
axess.set_ylim(top=150, bottom=-3)
...
# plt.show()
plt.savefig("prelim_figures/time_all.png")
